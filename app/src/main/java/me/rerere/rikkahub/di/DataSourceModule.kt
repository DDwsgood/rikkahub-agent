...
val dataSourceModule = module {
    ...
    single {
        ...
        Room.databaseBuilder(context, AppDatabase::class.java, "rikka_hub")
            ...
            .addMigrations(Migration_6_7, Migration_11_12, Migration_13_14, Migration_14_15, Migration_15_16, Migration_23_24, Migration_28_29)
    ...
    single { McpManager(settingsStore = get(), appScope = get(), filesManager = get(), workspaceRepository = get(), appEventBus = get()) }
